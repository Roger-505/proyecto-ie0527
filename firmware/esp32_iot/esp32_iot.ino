...
constexpr char WIFI_SSID[] = "Labo201";
constexpr char WIFI_PASSWORD[] = "labo201!";

// See https://thingsboard.io/docs/getting-started-guides/helloworld/
// to understand how to obtain an access token
constexpr char TOKEN[] = "b3fdbnpuz6zxc9fm9z3k";

// Thingsboard we want to establish a connection too
constexpr char THINGSBOARD_SERVER[] = "iot.eie.ucr.ac.cr";
